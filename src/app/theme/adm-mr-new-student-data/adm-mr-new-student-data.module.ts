...
import { AdmMrNewStudentDataRoutingModule } from './adm-mr-new-student-data-routing.module';
...
@NgModule({
  declarations: [AdmMrNewStudentDataComponent],
  imports: [
    CommonModule,
...
export class AdmMrNewStudentDataModule { }
