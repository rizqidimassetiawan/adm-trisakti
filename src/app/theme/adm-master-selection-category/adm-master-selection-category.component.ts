import { CategorySelectionService } from './../../_services/category-selection.service';
...
@Component({
  ...
  templateUrl: './adm-master-selection-category.component.html',
  styleUrls: ['./adm-master-selection-category.component.scss']
})
export class AdmMasterSelectionCategoryComponent implements OnInit {
  ...
  DataSelectionCategori = this.fb.group({
