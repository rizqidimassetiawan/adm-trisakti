...
@Component({
  ...
  templateUrl: './adm-mp-participant-data.component.html',
  styleUrls: ['./adm-mp-participant-data.component.scss']
})
export class AdmMpParticipantDataComponent implements OnInit {
