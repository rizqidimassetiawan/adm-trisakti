...
@Component({
  ...
  templateUrl: './participant-data-detail.component.html',
  styleUrls: ['./participant-data-detail.component.scss']
})
export class ParticipantDataDetailComponent implements OnInit {
  ...
  public loadtableRegistrationProgramStudy: boolean;
  public dataTableRegistrationProgramStudy: any;
  ...
  public participantRegistration: any;
  public keyName: any;
  ...
  @ViewChild('registrationDocumentModal', { static: true }) public registrationDocumentModal: any;
  ...
  public loadingParticipant: boolean;
  ...
  registrationDocumentForm = this.fb.group({
