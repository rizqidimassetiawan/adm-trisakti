...
@Component({
  ...
  templateUrl: './adm-master-type-examp.component.html',
  styleUrls: ['./adm-master-type-examp.component.scss']
})
export class AdmMasterTypeExampComponent implements OnInit {
