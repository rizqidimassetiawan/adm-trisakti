...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~activation-account-activation-account-module~adm-mr-detail-verification-document-data-adm-mr~dea0a82d"], {
  ...
  /***/
  function _src_app__services_participantServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ParticipantService = /*#__PURE__*/function (_base_service__WEBPAC) {
      function ParticipantService(http, router) {
        var _this;
        _classCallCheck(this, ParticipantService);
        _this = _callSuper(this, ParticipantService, [http]);
        _this.router = router;
      ...
      return _createClass(ParticipantService, [{
