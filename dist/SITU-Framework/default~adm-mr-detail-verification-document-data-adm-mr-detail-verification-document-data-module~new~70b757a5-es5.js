...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~adm-mr-detail-verification-document-data-adm-mr-detail-verification-document-data-module~new~70b757a5"], {
  ...
  /***/
  function _node_modules_angularDualListbox_fesm2015_angularDualListboxJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var DualListComponent = /*#__PURE__*/function () {
       ...
       * @return {?}
       */
      return _createClass(DualListComponent, [{
        key: "ngOnChanges",
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var AngularDualListBoxModule = /*#__PURE__*/_createClass(function AngularDualListBoxModule() {
  ...
  /***/
  function _node_modules_ng2MaterialDropdown_fesm2015_ng2MaterialDropdownJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Ng2DropdownButton = /*#__PURE__*/function () {
       ...
       */
      return _createClass(Ng2DropdownButton, [{
        key: "toggleMenu",
    ...
    var ACTIONS = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, KEYS.BACKSPACE, onBackspace), KEYS.PREV, onSwitchPrev), KEYS.NEXT, onSwitchNext), KEYS.ENTER, onItemClicked), KEYS.ESCAPE, onEscape);
    ...
    var Ng2DropdownState = /*#__PURE__*/function () {
       ...
       */
      return _createClass(Ng2DropdownState, [{
        key: "selectedItem",
        get: function get() {
    ...
    var Ng2MenuItem = /*#__PURE__*/function () {
      ...
      return _createClass(Ng2MenuItem, [{
        key: "ngOnDestroy",
    ...
    var Ng2DropdownMenu = /*#__PURE__*/function () {
       ...
       */
      return _createClass(Ng2DropdownMenu, [{
        key: "show",
    ...
    var Ng2Dropdown = /*#__PURE__*/function () {
      ...
      return _createClass(Ng2Dropdown, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this7 = this;
  ...
  /***/
  function _node_modules_ngxChips_fesm2015_ngxChipsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! @angular/common */"./node_modules/@angular/common/fesm2015/common.js");
    /* harmony import */
    var ng2_material_dropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! ng2-material-dropdown */"./node_modules/ng2-material-dropdown/fesm2015/ng2-material-dropdown.js");
    /* harmony import */
    ...
    /* harmony import */
    var _angular_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! @angular/animations */"./node_modules/@angular/animations/fesm2015/animations.js");
    ...
    var HighlightPipe = /*#__PURE__*/function () {
      ...
      return _createClass(HighlightPipe, [{
        key: "transform",
        value:
        /**
         * @name transform
    ...
    ** constants and default values for <tag-input>
    ...
    var DragProvider = /*#__PURE__*/function () {
       ...
       * @param tag
       */
      return _createClass(DragProvider, [{
        key: "setDraggedItem",
    ...
    var OptionsProvider = /*#__PURE__*/function () {
      ...
      return _createClass(OptionsProvider, [{
        key: "setOptions",
    ...
    var TagInputAccessor = /*#__PURE__*/function () {
      ...
      return _createClass(TagInputAccessor, [{
        key: "items",
        get: function get() {
          return this._items;
        },
    ...
    var TagInputForm = /*#__PURE__*/function () {
       ...
       * @name inputText
       */
      return _createClass(TagInputForm, [{
        key: "inputText",
        get: function get() {
    ...
    var TagComponent = /*#__PURE__*/function () {
      ...
      return _createClass(TagComponent, [{
        ...
        value: function storeNewValue(input) {
          ...
          var model = typeof this.model === 'string' ? input : _defineProperty(_defineProperty({
            index: this.index
          }, this.identifyBy, hasId() ? this.model[this.identifyBy] : input), this.displayBy, input);
    ...
    var TagInputDropdown = /*#__PURE__*/function () {
       ...
       * @param items
       */
      return _createClass(TagInputDropdown, [{
        ...
        function get() {
          ...
          return items.map(function (item) {
            return typeof item === 'string' ? _defineProperty(_defineProperty({}, _this11.displayBy, item), _this11.identifyBy, item) : item;
          });
        }
        /**
        ...
        value: function createTagModel(item) {
          ...
          return Object.assign({}, item.value, _defineProperty(_defineProperty({}, this.tagInput.displayBy, display), this.tagInput.identifyBy, value));
        }
        /**
         *
         * @param value {string}
        ...
        value: function getMatchingItems(value) {
          ...
          return this.autocompleteItems.filter(function (item) {
            var hasValue = dupesAllowed ? false : _this13.tagInput.tags.some(function (tag) {
              var identifyBy = _this13.tagInput.identifyBy;
              var model = typeof tag.model === 'string' ? tag.model : tag.model[identifyBy];
              return model === item[_this13.identifyBy];
            });
            return _this13.matchingFn(value, item) && hasValue === false;
          });
        }
        /**
         * @name setItems
        ...
        value: function populateItems(data) {
          ...
          this.autocompleteItems = data.map(function (item) {
            return typeof item === 'string' ? _defineProperty(_defineProperty({}, _this14.displayBy, item), _this14.identifyBy, item) : item;
          });
          return this;
        }
        /**
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]])], TagInputDropdown);
    ...
    var TagInputComponent = /*#__PURE__*/function (_TagInputAccessor) {
      function TagInputComponent(renderer, dragProvider) {
        ...
        _this15 = _callSuper(this, TagInputComponent);
        ...
        */
         ...
         */
        _this15.listeners = _defineProperty(_defineProperty({}, KEYDOWN, []), KEYUP, []);
        /**
        ...
        _this15.createTag = function (model) {
          ...
          return Object.assign({}, typeof model !== 'string' ? model : {}, _defineProperty(_defineProperty({}, _this15.displayBy, _this15.trimTags ? trim(model, _this15.displayBy) : model), _this15.identifyBy, _this15.trimTags ? trim(model, _this15.identifyBy) : model));
        };
        /**
         *
         * @param tag
        ...
        _this15.isTagValid = function (tag) {
          ...
          var dupe = _this15.findDupe(tag, fromAutocomplete);
          ...
          !dupe || _this15.allowDupes,
          // 2. check max items has not been reached
          !_this15.maxItemsReached,
        ...
        _this15.onPasteCallback = function (data) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this15, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var _this16 = this;
      ...
      return _createClass(TagInputComponent, [{
        key: "inputText",
        get: function get() {
        ...
        value: function setupSeparatorKeysListener() {
          ...
          var listener = function listener($event) {
            ...
            var hasKey = _this22.separatorKeys.indexOf($event.key) >= 0;
    ...
    var TagInputModule = /*#__PURE__*/function () {
      ...
      return _createClass(TagInputModule, null, [{
        key: "withDefaults",
        value:
        /**
         * @name withDefaults
...
//# sourceMappingURL=default~adm-mr-detail-verification-document-data-adm-mr-detail-verification-document-data-module~new~70b757a5-es5.js.map