...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~adm-mr-detail-verification-document-data-adm-mr-detail-verification-document-data-module~app~fffd3126"], {
  ...
  /***/
  function _src_app__services_adminManagementServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /* harmony import */
    var _classes_token_factory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! ../_classes/token.factory */"./src/app/_classes/token.factory.ts");
    /* harmony import */
    ...
    var AdminManagementService = /*#__PURE__*/function (_base_service__WEBPAC) {
      function AdminManagementService(http, router) {
        var _this;
        _classCallCheck(this, AdminManagementService);
        _this = _callSuper(this, AdminManagementService, [http]);
        _this.router = router;
      ...
      return _createClass(AdminManagementService, [{
        key: "getProgramData",
...
//# sourceMappingURL=default~adm-mr-detail-verification-document-data-adm-mr-detail-verification-document-data-module~app~fffd3126-es5.js.map